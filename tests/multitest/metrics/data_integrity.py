...
def column_missing_values_metric():
    return TestMetric(
        ...
        fingerprint="f2bacec8e7a77e5cf69deb0ba8b1e966",
...
def column_summary_metric():
    return TestMetric(
        ...
        fingerprint="4b66dfab6da342e4de19e7c0c692aeb5",
        outcomes=NoopOutcome(),
        dataset_names=["adult"],
    )
...
def column_summary_metric_period():
    ...
    return TestMetric(
        ...
        metric=m,
        fingerprint="5db07e6831975cb4eea1e0c88ca170e6",
        outcomes={
            TestDataset(
...
def column_summary_metric_success():
    ...
    return TestMetric(
        ...
        metric=m,
        fingerprint="e9fa32e14517045b40581f01a60c629d",
        outcomes={
            TestDataset(
...
def dataset_summary_metric():
    return TestMetric(
        ...
        fingerprint="c46d978158936d9e70a945c637902e26",
        outcomes=NoopOutcome(),
    )
...
def column_reg_exp_metric():
    return TestMetric(
        ...
        fingerprint="95835c87e7aac13e8a9a5c1094ac0e79",
        outcomes=NoopOutcome(),
        dataset_names=["adult"],
    )
...
def dataset_missing_values_metric():
    return TestMetric(
        ...
        fingerprint="c86546175db2c7d7402a6a3ddccffe4d",
        outcomes=NoopOutcome(),
    )
