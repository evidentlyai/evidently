...
def test_field_path():
    ...
    assert MockMetricResult.fields.list_nested_fields() == [
        "type",
        "field1.type",
        "field1.nested_field",
        "field2",
...
def test_field_path_with_dict():
    ...
    assert MockMetricResultWithDict.fields.list_nested_fields() == [
        "type",
        "d.*.type",
        "d.*.nested_field",
    ]

    assert MockMetricResultWithDict.fields.d.lol.list_fields() == [
        "type",
        "nested_field",
    ]
