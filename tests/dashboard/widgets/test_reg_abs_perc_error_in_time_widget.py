...
@pytest.fixture
def widget() -> RegAbsPercErrorTimeWidget:
    options_provider = OptionsProvider()

    widget = RegAbsPercErrorTimeWidget("test_widget")
    widget.options_provider = options_provider
    return widget


def test_reg_abs_perc_error_widget_analyzer_list(widget: RegAbsPercErrorTimeWidget) -> None:
...
def test_reg_abs_perc_error_widget_simple_case(
    widget: RegAbsPercErrorTimeWidget,
