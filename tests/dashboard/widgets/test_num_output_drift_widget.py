...
@pytest.mark.parametrize(
    ...
    (
        (
            ...
            ColumnMapping(),
            None,
            BaseWidgetInfo(type="big_graph", title="Target Drift: not detected, p_value=0.999961", size=2),
        ),
        (
            pd.DataFrame({"target": [1, 2, 3, 4, 5, 6, 7]}),
            pd.DataFrame({"target": [1, 2, 3, 1, 5, 6, 7]}),
        ...
        (
            ...
            ColumnMapping(),
            "prediction",
            BaseWidgetInfo(type="big_graph", title="Prediction Drift: not detected, p_value=0.999961", size=2),
        ),
        (
            pd.DataFrame({"data": [1, 2, 3, 4, 5, 6, 7]}),
            pd.DataFrame({"data": [1, 2, 3, 1, 5, 6, 7]}),
