...
@pytest.fixture
def widget() -> ClassQualityMetricsBarWidget:
    options_provider = OptionsProvider()

    widget = ClassQualityMetricsBarWidget("test_widget")
    widget.options_provider = options_provider
    return widget


@pytest.mark.parametrize("dataset", ("reference", "current"))
def test_class_quality_metrics_bar_widget_simple_case(widget: ClassQualityMetricsBarWidget, dataset: str) -> None:
