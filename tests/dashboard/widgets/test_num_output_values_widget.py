...
@pytest.fixture
def widget() -> NumOutputValuesWidget:
    options_provider = OptionsProvider()

    widget = NumOutputValuesWidget("test_widget")
    widget.options_provider = options_provider
    return widget


def test_num_output_values_widget_analyzer_list(widget: NumOutputValuesWidget) -> None:
...
def test_num_output_values_widget_simple_case(
    widget: NumOutputValuesWidget,
...
def test_num_output_values_widget_value_error(
    widget: NumOutputValuesWidget,
    reference_data: pd.DataFrame,
    current_data: pd.DataFrame,
    data_mapping: ColumnMapping,
