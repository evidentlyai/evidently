...
@pytest.fixture
def widget() -> ProbClassSupportWidget:
    options_provider = OptionsProvider()

    widget = ProbClassSupportWidget("test_widget")
    widget.options_provider = options_provider
    return widget


def test_prob_class_support_widget_analyzer_list(widget: ProbClassSupportWidget) -> None:
...
def test_prob_class_support_widget_simple_case(
    widget: ProbClassSupportWidget,
