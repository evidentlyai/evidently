...
@pytest.fixture
def widget() -> ProbClassQualityMetricBarWidget:
    options_provider = OptionsProvider()

    widget = ProbClassQualityMetricBarWidget("test_widget")
    widget.options_provider = options_provider
    return widget


def test_prob_class_quality_metrics_widget_analyzer_list(widget: ProbClassQualityMetricBarWidget) -> None:
...
def test_prob_class_quality_metrics_widget_simple_case(
    widget: ProbClassQualityMetricBarWidget,
