...
@pytest.fixture
def widget() -> RegPredActualTimeWidget:
    options_provider = OptionsProvider()

    widget = RegPredActualTimeWidget("test_widget")
    widget.options_provider = options_provider
    return widget


def test_reg_pred_actual_time_widget_analyzer_list(widget: RegPredActualTimeWidget) -> None:
...
def test_reg_pred_actual_time_widget_simple_case(
    widget: RegPredActualTimeWidget,
