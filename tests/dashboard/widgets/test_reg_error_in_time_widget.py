...
@pytest.fixture
def widget() -> RegErrorTimeWidget:
    options_provider = OptionsProvider()

    widget = RegErrorTimeWidget("test_widget")
    widget.options_provider = options_provider
    return widget


def test_reg_error_in_time_widget_analyzer_list(widget: RegErrorTimeWidget) -> None:
...
def test_reg_error_in_time_widget_simple_case(
    widget: RegErrorTimeWidget,
