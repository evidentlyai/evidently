...
@pytest.fixture
def widget() -> RegQualityMetricsBarWidget:
    options_provider = OptionsProvider()

    widget = RegQualityMetricsBarWidget("test_widget")
    widget.options_provider = options_provider
    return widget


def test_reg_quality_metrics_bar_widget_analyzer_list(widget: RegQualityMetricsBarWidget) -> None:
...
def test_reg_quality_metrics_bar_widget_simple_case(
    widget: RegQualityMetricsBarWidget,
