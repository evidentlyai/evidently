...
@pytest.fixture
def widget() -> RegErrorDistrWidget:
    options_provider = OptionsProvider()

    widget = RegErrorDistrWidget("test_widget")
    widget.options_provider = options_provider
    return widget


def test_reg_reg_error_distr_widget_analyzer_list(widget: RegErrorDistrWidget) -> None:
...
def test_reg_error_distr_widget_simple_case(
    widget: RegErrorDistrWidget,
