...
@pytest.fixture
def widget() -> ProbClassMetricsMatrixWidget:
    options_provider = OptionsProvider()

    widget = ProbClassMetricsMatrixWidget("test_widget")
    widget.options_provider = options_provider
    return widget


def test_prob_class_metrics_matrix_widget_analyzer_list(widget: ProbClassMetricsMatrixWidget) -> None:
...
def test_prob_class_metrics_matrix_widget_simple_case(
    widget: ProbClassMetricsMatrixWidget,
