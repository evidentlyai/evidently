...
> This will launch a demo project with the Evidently UI service. You can find a complete [Get Started with Monitoring Tutorial](https://docs.evidentlyai.com/get-started/tutorial-monitoring) in the docs.
