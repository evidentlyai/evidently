...
> **Note**
> We added a new Report object starting from v0.1.59. Reports unite the functionality of Dashboards and JSON profiles with a new, cleaner API. The old Dashboards API was removed from the code base in v0.2.9. If your existing code is breaking, read the [guide](docs/book/support/migration.md).
