...
import {TestSuiteWidgetParams, TestDataInfo, TestGroupData, TestGroupTypeData} from "../../api/Api";
...
const TestGroup: React.FC<{ groupInfo: TestGroupData, tests: TestDataInfo[] }> = ({groupInfo, tests}) => {
        ...
        <Grid container spacing={2}>
            {Array.from(grouped.entries())
                .map(([key, value]) => [actualGroups.find(t => t.id === key) ?? {
                    id: key,
                    title: key
                }, value] as [TestGroupData, TestDataInfo[]])
                .sort((a, b) =>
...
const DefaultGroups: TestGroupTypeData[] = [
    {id: "none", title: "All tests", values: []},
    {
        id: "status", title: "By test status", values: [
            ...
            {id: "warning", title: "Failed non-critical tests", sortIndex: 2, description: "", severity: "warning"},
