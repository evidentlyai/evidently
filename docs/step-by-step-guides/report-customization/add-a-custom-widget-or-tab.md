...
To create a new Widget, you should create a class derived from our base class: [https://github.com/evidentlyai/evidently/blob/main/evidently/widgets/widget.py](https://github.com/evidentlyai/evidently/blob/main/evidently/widgets/widget.py)
...
Create a new Python file. Copy the code from [https://github.com/evidentlyai/evidently/blob/main/evidently/widgets/RegPredActualTimeWidget.py](https://github.com/evidentlyai/evidently/blob/main/evidently/widgets/RegPredActualTimeWidget.py) - we will use it as starting point and edit to create a custom implementation.&#x20;
...
Creating a custom Tab is even easier. You need to create a class derived from the base class: [https://github.com/evidentlyai/evidently/blob/main/evidently/tabs/base\_tab.py](https://github.com/evidentlyai/evidently/blob/main/evidently/tabs/base\_tab.py)
