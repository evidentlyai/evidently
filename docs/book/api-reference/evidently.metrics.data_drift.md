...
### _class_ evidently.metrics.data_drift.column_drift_metric.ColumnDriftMetric(column_name: str, options: Optional[[DataDriftOptions](api-reference/evidently.options.md#evidently.options.data_drift.DataDriftOptions)] = None)
Bases: [`Metric`](api-reference/evidently.metrics.md#evidently.metrics.base_metric.Metric)[`ColumnDriftMetricResults`]
...
### _class_ evidently.metrics.data_drift.column_drift_metric.ColumnDriftMetricRenderer(color_options: Optional[[ColorOptions](api-reference/evidently.options.md#evidently.options.color_scheme.ColorOptions)] = None)
...
Bases: [`Metric`](api-reference/evidently.metrics.md#evidently.metrics.base_metric.Metric)[`ColumnValuePlotResults`]
...
### _class_ evidently.metrics.data_drift.column_value_plot.ColumnValuePlotRenderer(color_options: Optional[[ColorOptions](api-reference/evidently.options.md#evidently.options.color_scheme.ColorOptions)] = None)
Bases: [`MetricRenderer`](api-reference/evidently.renderers.md#evidently.renderers.base_renderer.MetricRenderer)
...
### _class_ evidently.metrics.data_drift.data_drift_table.DataDriftTable(columns: Optional[List[str]] = None, options: Optional[[DataDriftOptions](api-reference/evidently.options.md#evidently.options.data_drift.DataDriftOptions)] = None)
Bases: [`Metric`](api-reference/evidently.metrics.md#evidently.metrics.base_metric.Metric)[`DataDriftTableResults`]
...
### _class_ evidently.metrics.data_drift.data_drift_table.DataDriftTableRenderer(color_options: Optional[[ColorOptions](api-reference/evidently.options.md#evidently.options.color_scheme.ColorOptions)] = None)
Bases: [`MetricRenderer`](api-reference/evidently.renderers.md#evidently.renderers.base_renderer.MetricRenderer)
...
#### drift_by_columns(_: Dict[str, [ColumnDataDriftMetrics](api-reference/evidently.calculations.md#evidently.calculations.data_drift.ColumnDataDriftMetrics)_ )
...
### _class_ evidently.metrics.data_drift.dataset_drift_metric.DataDriftMetricsRenderer(color_options: Optional[[ColorOptions](api-reference/evidently.options.md#evidently.options.color_scheme.ColorOptions)] = None)
Bases: [`MetricRenderer`](api-reference/evidently.renderers.md#evidently.renderers.base_renderer.MetricRenderer)
...
### _class_ evidently.metrics.data_drift.dataset_drift_metric.DatasetDriftMetric(columns: Optional[List[str]] = None, threshold: float = 0.5, options: Optional[[DataDriftOptions](api-reference/evidently.options.md#evidently.options.data_drift.DataDriftOptions)] = None)
Bases: [`Metric`](api-reference/evidently.metrics.md#evidently.metrics.base_metric.Metric)[`DatasetDriftMetricResults`]
...
Bases: [`Metric`](api-reference/evidently.metrics.md#evidently.metrics.base_metric.Metric)[`TargetByFeaturesTableResults`]
...
### _class_ evidently.metrics.data_drift.target_by_features_table.TargetByFeaturesTableRenderer(color_options: Optional[[ColorOptions](api-reference/evidently.options.md#evidently.options.color_scheme.ColorOptions)] = None)
Bases: [`MetricRenderer`](api-reference/evidently.renderers.md#evidently.renderers.base_renderer.MetricRenderer)
...
#### curr_predictions(_: Optional[[PredictionData](api-reference/evidently.calculations.md#evidently.calculations.classification_performance.PredictionData)_ )
