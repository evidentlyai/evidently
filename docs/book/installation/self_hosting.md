...
In addition to using Evidently Python library, you can self-host UI service to get a monitoring dashboard and organize the results of your evaluations. This is optional: you can also run evaluations in your Python environment without self-hosting the Dashboard. 
