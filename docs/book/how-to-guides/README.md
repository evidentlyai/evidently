...
Test and Reports | How to calculate metrics for ranking and recommender systems?|<ul><li>[Jupyter notebook](https://github.com/evidentlyai/evidently/blob/main/examples/how_to_questions/how_to_calculate_recsys_metrics.ipynb)</li></ul>
