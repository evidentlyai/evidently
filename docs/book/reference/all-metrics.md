...
| Metric name | Description | Parameters |
|---|---|---|
| `DatasetDriftMetric()`<br>  | Dataset-level.<br><br>Calculates the number and share of drifted features. Returns true/false for the dataset drift at a given threshold (defined by the share of drifting features). Each feature is tested for drift individually using the default algorithm.| **Required:**<br>n/a<br><br>**Optional:**<ul><li>`сolumns` (default=all)</li><li>`drift_share`(default for dataset drift = 0.5)</li> <li>`stattest`</li><li>`cat_stattest`</li><li>`num_stattest`</li><li>`per_column_stattest`</li><li>`stattest_threshold`</li><li>`cat_stattest_threshold`</li><li>`num_stattest_threshold`</li><li>`per_column_stattest_threshold`</li></ul><br>[How to set data drift parameters](../customization/options-for-statistical-tests.md).  |
| `DataDriftTable()` | Dataset-level.<br><br>Calculates data drift for all columns in the dataset, or for a defined list of columns. Returns drift detection results for each column and visualizes distributions.  | **Required:**<br>n/a<br><br>**Optional:** <ul><li>`сolumns`</li><li>`stattest`</li><li>`cat_stattest`</li><li>`num_stattest`</li><li>`per_column_stattest`</li><li>`stattest_threshold`</li><li>`cat_stattest_threshold`</li><li>`num_stattest_threshold`</li><li>`per_column_stattest_threshold`</li></ul><br><br> [How to set data drift parameters](../customization/options-for-statistical-tests.md)|
| ColumnDriftMetric('age') | Column-level. <br><br>Calculates data drift for the defined column. Visualizes distributions for a given column.  | **Required:**<ul><li>`column_name`</li></ul><br><br>**Optional:**<ul><li>`stattest`</li><li>`stattest_threshold`</li> </li></ul><br> [How to set data drift parameters](../customization/options-for-statistical-tests.md)||
