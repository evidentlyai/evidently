...
| **EmbeddingsDriftMetric**('small_subset')| Column-level. <br><br>Calculates data drift for embeddings. | **Required:**<ul><li>`column_name`</li></ul><br>**Optional:**<ul><li>`drift_method`</li></ul>|
