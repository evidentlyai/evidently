...
class RegressionPerformanceTab(Tab):
    widgets = [
        ...
        (RegAbsPercErrorTimeWidget("Reference: Absolute Percentage Error"), Verbose.ALWAYS),
        (RegAbsPercErrorTimeWidget("Current: Absolute Percentage Error", dataset='current'), Verbose.ALWAYS),
        ...
        (RegErrorNormalityWidget("Reference: Error Normality"), Verbose.ALWAYS),
        (RegErrorNormalityWidget("Current: Error Normality", dataset='current'), Verbose.ALWAYS),
        (RegUnderperformMetricsWidget("Reference: Mean Error per Group (+/- std)"), Verbose.ALWAYS),
        (RegUnderperformMetricsWidget("Current: Mean Error per Group (+/- std)", dataset='current'), Verbose.ALWAYS),
        (RegColoredPredActualWidget("Reference: Predicted vs Actual per Group"), Verbose.ALWAYS),
        (RegColoredPredActualWidget("Current: Predicted vs Actual per Group", dataset='current'), Verbose.ALWAYS),
        (UnderperformSegmTableWidget("Error Bias: Mean/Most Common Feature Value per Group"), Verbose.ALWAYS),
    ]
