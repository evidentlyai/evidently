...
class TestNumpyEncoder:
    ...
    def test_bool_covert(self, numpy_encoder):
    ...
    def test_array_covert(self, numpy_encoder):
    ...
    def test_none_covert(self, numpy_encoder):
