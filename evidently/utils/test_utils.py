...
def test_bool_covert(numpy_encoder: NumpyEncoder):
...
def test_array_covert(numpy_encoder: NumpyEncoder):
...
def test_none_covert(numpy_encoder: NumpyEncoder):
