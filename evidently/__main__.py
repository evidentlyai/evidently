...
pipline_parser = parsers.add_parser("calculate")
pipline_parser.add_argument("--config", dest="config", required=True, help="Path to configuration")
pipline_parser.add_argument("--reference", dest="reference", required=True, help="Path to reference data")
pipline_parser.add_argument("--current", dest="current", help="Path to current data")
pipline_parser.add_argument("--output_path", dest="output_path", required=True, help="Path to store report")
pipline_parser.add_argument("--output_type", dest="output_type", required=True, help="Report type: html (preffered) or json")
pipline_parser.add_argument("--report_name", dest="report_name", default="report", help="Report name")
pipline_parser.set_defaults(handler=analyze_handler)
