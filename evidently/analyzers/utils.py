...
class DatasetUtilityColumns:
    def __init__(self, date: str, id_column: str, target: str, prediction: str):
        self.date = date
...
class DatasetColumns:
    def __init__(self, utility_columns: DatasetUtilityColumns, num_feature_names, cat_feature_names, target_names):
