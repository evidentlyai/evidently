...
class ClassificationQualityMetric(
    ...
    def __init__(
        ...
        self._confusion_matrix_metric = ClassificationConfusionMatrix(
    ...
    def calculate(self, data: InputData) -> ClassificationQualityMetricResult:
        ...
        if data.reference_data is not None:
            ...
            if ref_matrix is None:
                raise ValueError(
                    f"Dependency {self._confusion_matrix_metric.__class__} should have reference data"
                )
            target, prediction = self.get_target_prediction_data(
        ...
        result = ClassificationQualityMetricResult(
