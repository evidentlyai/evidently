...
class TextDescriptorsCorrelationMetricResult(MetricResult):
    __type_alias__: ClassVar = "evidently:metric_result:TextDescriptorsCorrelationMetricResult"
...
class TextDescriptorsCorrelationMetric(Metric[TextDescriptorsCorrelationMetricResult]):
    __type_alias__: ClassVar = "evidently:metric:TextDescriptorsCorrelationMetric"
