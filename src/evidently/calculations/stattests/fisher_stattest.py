...
def _fisher_test(reference_data: pd.Series, current_data: pd.Series, feature_type: str, threshold: float) -> Tuple[float, bool]:
...
fisher_exact_test = StatTest(
    name="fisher", display_name="Fisher's Exact test", func=_fisher_test, 
    allowed_feature_types=["cat"], default_threshold = 0.1)
