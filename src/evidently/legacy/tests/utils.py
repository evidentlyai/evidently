...
from evidently.legacy.metric_results import RatesPlotData
...
np._core.numeric.ScalarType = np._core.numeric.ScalarType + (ApproxValue, ApproxValueNoDict)  # type: ignore[attr-defined,assignment]
