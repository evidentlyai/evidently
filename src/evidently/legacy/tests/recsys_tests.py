...
from evidently.legacy.utils.visualizations import plot_4_distr
...
class TestRecallTopK(BaseTopkRecsysTest):
    __type_alias__: ClassVar[Optional[str]] = "evidently:test:TestRecallTopK"
...
class TestMAPK(BaseTopkRecsysTest):
    __type_alias__: ClassVar[Optional[str]] = "evidently:test:TestMAPK"
...
class TestMARK(BaseTopkRecsysTest):
    __type_alias__: ClassVar[Optional[str]] = "evidently:test:TestMARK"
...
class TestNDCGK(BaseTopkRecsysTest):
    __type_alias__: ClassVar[Optional[str]] = "evidently:test:TestNDCGK"
...
class TestHitRateK(BaseTopkRecsysTest):
    __type_alias__: ClassVar[Optional[str]] = "evidently:test:TestHitRateK"
...
class TestNovelty(BaseNotRankRecsysTest[NoveltyMetric]):
    __type_alias__: ClassVar[Optional[str]] = "evidently:test:TestNovelty"
...
class TestDiversity(BaseNotRankRecsysTest[DiversityMetric]):
    __type_alias__: ClassVar[Optional[str]] = "evidently:test:TestDiversity"
...
class TestSerendipity(BaseNotRankRecsysTest[SerendipityMetric]):
    __type_alias__: ClassVar[Optional[str]] = "evidently:test:TestSerendipity"
...
class TestPersonalization(BaseNotRankRecsysTest[PersonalizationMetric]):
    __type_alias__: ClassVar[Optional[str]] = "evidently:test:TestPersonalization"
...
class TestARP(BaseCheckValueTest):
    __type_alias__: ClassVar[Optional[str]] = "evidently:test:TestARP"
...
class TestGiniIndex(BaseCheckValueTest):
    __type_alias__: ClassVar[Optional[str]] = "evidently:test:TestGiniIndex"
...
class TestScoreEntropy(BaseCheckValueTest):
    __type_alias__: ClassVar[Optional[str]] = "evidently:test:TestScoreEntropy"
