...
class BaseDescriptor(EvidentlyBaseModel):
    __type_alias__: ClassVar[Optional[str]] = "evidently:descriptor:BaseDescriptor"
    __is_base_type__: ClassVar[bool] = True
...
class MultiColumnFeatureDescriptor(BaseDescriptor):
    __type_alias__: ClassVar[Optional[str]] = "evidently:descriptor:MultiColumnFeatureDescriptor"
    __is_base_type__: ClassVar[bool] = True
