...
class Contains(GeneratedFeature):
    __type_alias__: ClassVar[Optional[str]] = "evidently:feature:Contains"
...
class DoesNotContain(GeneratedFeature):
    __type_alias__: ClassVar[Optional[str]] = "evidently:feature:DoesNotContain"
...
class ItemMatch(GeneratedFeature):
    __type_alias__: ClassVar[Optional[str]] = "evidently:feature:ItemMatch"
...
class ItemNoMatch(GeneratedFeature):
    __type_alias__: ClassVar[Optional[str]] = "evidently:feature:ItemNoMatch"
