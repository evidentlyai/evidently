...
from evidently.legacy.utils.visualizations import plot_bias


class ItemBiasMetricResult(MetricResult):
    __type_alias__: ClassVar[Optional[str]] = "evidently:metric_result:ItemBiasMetricResult"
...
class ItemBiasMetric(Metric[ItemBiasMetricResult]):
    __type_alias__: ClassVar[Optional[str]] = "evidently:metric:ItemBiasMetric"
