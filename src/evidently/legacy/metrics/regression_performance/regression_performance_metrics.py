...
class RegressionMetrics(MetricResult):
    __type_alias__: ClassVar[Optional[str]] = "evidently:metric_result:RegressionMetrics"
    __pd_exclude_fields__: ClassVar[set] = {"underperformance"}
    __field_tags__: ClassVar[Dict[str, set]] = {"underperformance": {IncludeTags.Extra}}
...
class RegressionPerformanceMetricsResults(MetricResult):
    __type_alias__: ClassVar[Optional[str]] = "evidently:metric_result:RegressionPerformanceMetricsResults"
...
class RegressionPerformanceMetrics(Metric[RegressionPerformanceMetricsResults]):
    __type_alias__: ClassVar[Optional[str]] = "evidently:metric:RegressionPerformanceMetrics"
