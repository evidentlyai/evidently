...
from evidently.legacy.metrics.regression_performance.objects import PredActualScatter
from evidently.legacy.metrics.regression_performance.objects import RegressionScatter
from evidently.legacy.metrics.regression_performance.visualization import plot_error_bias_colored_scatter
...
from evidently.legacy.utils.visualizations import plot_top_error_contours


class TopData(MetricResult):
    __type_alias__: ClassVar[Optional[str]] = "evidently:metric_result:TopData"
...
class AggTopData(MetricResult):
    __type_alias__: ClassVar[Optional[str]] = "evidently:metric_result:AggTopData"
...
class RegressionTopErrorMetricResults(MetricResult):
    __type_alias__: ClassVar[Optional[str]] = "evidently:metric_result:RegressionTopErrorMetricResults"
...
class RegressionTopErrorMetric(UsesRawDataMixin, Metric[RegressionTopErrorMetricResults]):
    __type_alias__: ClassVar[Optional[str]] = "evidently:metric:RegressionTopErrorMetric"
