...
class RegressionErrorNormalityResults(MetricResult):
    __type_alias__: ClassVar[Optional[str]] = "evidently:metric_result:RegressionErrorNormalityResults"
    __dict_exclude_fields__: ClassVar[set] = {
        "current_plot",
        "current_theoretical",
        "reference_plot",
...
class RegressionErrorNormality(UsesRawDataMixin, Metric[RegressionErrorNormalityResults]):
    __type_alias__: ClassVar[Optional[str]] = "evidently:metric:RegressionErrorNormality"
