...
from evidently.legacy.calculations.data_integration import get_number_of_constant_columns
from evidently.legacy.calculations.data_integration import get_number_of_duplicated_columns
from evidently.legacy.calculations.data_integration import get_number_of_empty_columns
...
class DatasetSummary(MetricResult):
    ...
    __type_alias__: ClassVar[Optional[str]] = "evidently:metric_result:DatasetSummary"
    __dict_exclude_fields__: ClassVar[set] = {"columns_type_data"}
    __pd_exclude_fields__: ClassVar[set] = {"columns_type_data", "nans_by_columns", "number_uniques_by_columns"}
...
class DatasetSummaryMetricResult(MetricResult):
    __type_alias__: ClassVar[Optional[str]] = "evidently:metric_result:DatasetSummaryMetricResult"
    __field_tags__: ClassVar[Dict[str, set]] = {
...
class DatasetSummaryMetric(Metric[DatasetSummaryMetricResult]):
    __type_alias__: ClassVar[Optional[str]] = "evidently:metric:DatasetSummaryMetric"
