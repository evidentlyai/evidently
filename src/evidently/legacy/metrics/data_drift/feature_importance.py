...
class FeatureImportanceMetricResult(MetricResult):
    __type_alias__: ClassVar[Optional[str]] = "evidently:metric_result:FeatureImportanceMetricResult"
...
class FeatureImportanceMetric(Metric[FeatureImportanceMetricResult]):
    __type_alias__: ClassVar[Optional[str]] = "evidently:metric:FeatureImportanceMetric"
