...
class TargetByFeaturesTableResults(MetricResult):
    __type_alias__: ClassVar[Optional[str]] = "evidently:metric_result:TargetByFeaturesTableResults"
...
class TargetByFeaturesTable(UsesRawDataMixin, Metric[TargetByFeaturesTableResults]):
    __type_alias__: ClassVar[Optional[str]] = "evidently:metric:TargetByFeaturesTable"
