...
class DistanceDriftMethod(DriftMethod):
    __type_alias__: ClassVar[Optional[str]] = "evidently:drift_method:DistanceDriftMethod"
...
class RatioDriftMethod(DriftMethod):
    __type_alias__: ClassVar[Optional[str]] = "evidently:drift_method:RatioDriftMethod"
...
class MMDDriftMethod(DriftMethod):
    __type_alias__: ClassVar[Optional[str]] = "evidently:drift_method:MMDDriftMethod"
