...
class TextDomainField(MetricResult):
    __type_alias__: ClassVar[Optional[str]] = "evidently:metric_result:TextDomainField"
...
class TextDomainClassifierDriftResult(MetricResult):
    __type_alias__: ClassVar[Optional[str]] = "evidently:metric_result:TextDomainClassifierDriftResult"
...
class TextDomainClassifierDriftMetric(Metric[TextDomainClassifierDriftResult]):
    __type_alias__: ClassVar[Optional[str]] = "evidently:metric:TextDomainClassifierDriftMetric"
