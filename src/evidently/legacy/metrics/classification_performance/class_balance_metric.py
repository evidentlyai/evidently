...
class ClassificationClassBalanceResult(MetricResult):
    __type_alias__: ClassVar[Optional[str]] = "evidently:metric_result:ClassificationClassBalanceResult"
    __dict_exclude_fields__: ClassVar[set] = {"plot_data"}
    __pd_exclude_fields__: ClassVar[set] = {"plot_data"}

    plot_data: Histogram


class ClassificationClassBalance(Metric[ClassificationClassBalanceResult]):
    __type_alias__: ClassVar[Optional[str]] = "evidently:metric:ClassificationClassBalance"
