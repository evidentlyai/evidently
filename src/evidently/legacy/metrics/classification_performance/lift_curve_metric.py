...
class ClassificationLiftCurveResults(MetricResult):
    __type_alias__: ClassVar[Optional[str]] = "evidently:metric_result:ClassificationLiftCurveResults"
...
class ClassificationLiftCurve(Metric[ClassificationLiftCurveResults]):
    __type_alias__: ClassVar[Optional[str]] = "evidently:metric:ClassificationLiftCurve"
