...
class ConflictPredictionMetricResults(MetricResult):
    __type_alias__: ClassVar[Optional[str]] = "evidently:metric_result:ConflictPredictionMetricResults"
...
class ConflictPredictionMetric(Metric[ConflictPredictionMetricResults]):
    __type_alias__: ClassVar[Optional[str]] = "evidently:metric:ConflictPredictionMetric"
