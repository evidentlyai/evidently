...
class DataQualityStabilityMetricResult(MetricResult):
    __type_alias__: ClassVar[Optional[str]] = "evidently:metric_result:DataQualityStabilityMetricResult"
...
class DataQualityStabilityMetric(Metric[DataQualityStabilityMetricResult]):
    __type_alias__: ClassVar[Optional[str]] = "evidently:metric:DataQualityStabilityMetric"
