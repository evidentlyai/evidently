...
class DashboardPanelPlot(DashboardPanel):
    __type_alias__: ClassVar[Optional[str]] = "evidently:dashboard_panel:DashboardPanelPlot"
...
class DashboardPanelDistribution(DashboardPanel):
    __type_alias__: ClassVar[Optional[str]] = "evidently:dashboard_panel:DashboardPanelDistribution"
