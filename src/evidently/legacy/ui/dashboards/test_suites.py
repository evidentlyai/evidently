...
class DashboardPanelTestSuite(DashboardPanel):
    __type_alias__: ClassVar[Optional[str]] = "evidently:dashboard_panel:DashboardPanelTestSuite"
...
class DashboardPanelTestSuiteCounter(DashboardPanel):
    __type_alias__: ClassVar[Optional[str]] = "evidently:dashboard_panel:DashboardPanelTestSuiteCounter"
