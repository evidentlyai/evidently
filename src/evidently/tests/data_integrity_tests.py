...
class TestNumberOfColumns(BaseIntegrityValueTest):
    __type_alias__: ClassVar = "evidently:test:TestNumberOfColumns"
...
class TestNumberOfRows(BaseIntegrityValueTest):
    __type_alias__: ClassVar = "evidently:test:TestNumberOfRows"
...
class TestNumberOfDifferentMissingValues(BaseIntegrityMissingValuesValuesTest):
    __type_alias__: ClassVar = "evidently:test:TestNumberOfDifferentMissingValues"
...
class TestNumberOfMissingValues(BaseIntegrityMissingValuesValuesTest):
    __type_alias__: ClassVar = "evidently:test:TestNumberOfMissingValues"
...
class TestShareOfMissingValues(BaseIntegrityMissingValuesValuesTest):
    __type_alias__: ClassVar = "evidently:test:TestShareOfMissingValues"
...
class TestNumberOfColumnsWithMissingValues(BaseIntegrityMissingValuesValuesTest):
    __type_alias__: ClassVar = "evidently:test:TestNumberOfColumnsWithMissingValues"
...
class TestShareOfColumnsWithMissingValues(BaseIntegrityMissingValuesValuesTest):
    __type_alias__: ClassVar = "evidently:test:TestShareOfColumnsWithMissingValues"
...
class TestShareOfRowsWithMissingValues(BaseIntegrityMissingValuesValuesTest):
    __type_alias__: ClassVar = "evidently:test:TestShareOfRowsWithMissingValues"
...
class TestColumnNumberOfDifferentMissingValues(BaseIntegrityColumnMissingValuesTest):
    __type_alias__: ClassVar = "evidently:test:TestColumnNumberOfDifferentMissingValues"
...
class TestColumnNumberOfMissingValues(BaseIntegrityColumnMissingValuesTest):
    __type_alias__: ClassVar = "evidently:test:TestColumnNumberOfMissingValues"
...
class TestColumnShareOfMissingValues(BaseIntegrityColumnMissingValuesTest):
    __type_alias__: ClassVar = "evidently:test:TestColumnShareOfMissingValues"
...
class TestNumberOfConstantColumns(BaseIntegrityValueTest):
    __type_alias__: ClassVar = "evidently:test:TestNumberOfConstantColumns"
...
class TestColumnAllConstantValues(BaseIntegrityOneColumnTest):
    __type_alias__: ClassVar = "evidently:test:TestColumnAllConstantValues"
...
class TestColumnAllUniqueValues(BaseIntegrityOneColumnTest):
    __type_alias__: ClassVar = "evidently:test:TestColumnAllUniqueValues"
...
class ColumnTypeParameter(TestParameters):
    __type_alias__: ClassVar = "evidently:test_parameters:ColumnTypeParameter"
...
class ColumnTypesParameter(TestParameters):
    __type_alias__: ClassVar = "evidently:test_parameters:ColumnTypesParameter"

    columns: List[ColumnTypeParameter]


class TestColumnsType(Test):
    __type_alias__: ClassVar = "evidently:test:TestColumnsType"
