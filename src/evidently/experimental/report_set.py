...
from evidently.suite.base_suite import Display, Snapshot


def load_snapshots(path: str, date_from: Optional[datetime.datetime] = None,
    date_to: Optional[datetime.datetime] = None, skip_errors: bool = False) -> Dict[uuid.UUID, Snapshot]:
    result = {}
