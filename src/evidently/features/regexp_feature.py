...
class RegExp(GeneratedFeature):
    ...
    def __init__(
        self, column_name: str, reg_exp: str, display_name: Optional[str] = None
    ):
    ...
    def generate_feature(
        ...
        result = (
            data[self.column_name].astype(str).str.fullmatch(self.reg_exp).astype(int)
        )
    ...
    def feature_name(self):
        return additional_feature(
            ...
            self.display_name
            or f"RegExp '{self.reg_exp}' Match for column {self.column_name}",
        )
