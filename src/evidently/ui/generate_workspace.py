        ...
        DashboardPanelPlot(
            ...
            values=[
                ...
                PanelValue(
                    ...
                    field_path=DatasetMissingValuesMetric.result_fields().current.share_of_missing_values,
        ...
        DashboardPanelPlot(
            ...
            values=[
                PanelValue(
                    ...
                    field_path=ColumnDriftMetric.result_fields().drift_score,
                    legend="Drift Score",
                ),
            ],
            plot_type=PlotType.LINE,
        ...
        DashboardPanelPlot(
            ...
            values=[
                PanelValue(
                    ...
                    field_path=ColumnQuantileMetric.result_fields().current.value,
                    legend="Quantile",
                ),
            ],
            plot_type=PlotType.LINE,
